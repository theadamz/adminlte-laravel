...
return [
    'general' => [
        'web_name' => 'AdminLTE Laravel',
        'web_name_short' => 'AdminLTE Laravel',
        'web_description' => 'Web Admin with Roles, Permissions and accessses',
        'web_keywords' => 'web admin, RBAC, roles and permission, code samples',
        'web_author' => 'theadamz',

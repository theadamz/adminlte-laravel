...
async function editData(id = null) {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/basics/brands/${_id}`, 'GET');
...
async function deleteData() {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/basics/brands`, "DELETE", _data2Send);
...
async function importData() {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/basics/brands/imports`, "POST", _data2Send, null);
...
async function exportData() {
    ...
    // get data
    const response = await axiosCustom(`${_baseURL}/basics/brands/exports`, 'POST', {

...
function initDataTable() {
    _dataTable = $('#list_datatable').DataTable({
        ...
        "ajax": {
            "url": `${_baseURL}/dt/basics/categories`,
            "type": "GET",
            "data": function (d) {
...
async function saveData() {
    ...
    // prepare url
    url = `${_baseURL}/basics/categories`;
...
async function editData(id = null) {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/basics/categories/${_id}`, 'GET');
...
async function deleteData() {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/basics/categories`, "DELETE", _data2Send);
...
async function importData() {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/basics/categories/imports`, "POST", _data2Send, null);
...
async function exportData() {
    ...
    // get data
    const response = await axiosCustom(`${_baseURL}/basics/categories/exports`, 'POST', {

...
function initDataTable() {
    _dataTable = $('#list_datatable').DataTable({
        ...
        "ajax": {
            "url": `${_baseURL}/dt/basics/warehouses/${warehouseId}/locations`,
            "type": "GET",
            "data": function (d) {
...
function initMaxLengthForm() {
    initMaxLength('#code');
    initMaxLength('#name');
    initMaxLength('#address');
    initMaxLength('#telephone');
    initMaxLength('#fax');
}
...
async function saveData() {
    ...
    // prepare url
    url = `${_baseURL}/basics/warehouses/${warehouseId}/locations`;
...
async function editData(id = null) {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/basics/warehouses/${warehouseId}/locations/${_id}`, 'GET');
...
async function deleteData() {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/basics/warehouses/${warehouseId}/locations`, "DELETE", _data2Send);
...
async function importData() {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/basics/warehouses/${warehouseId}/locations/imports`, "POST", _data2Send, null);
...
async function exportData() {
    ...
    // get data
    const response = await axiosCustom(`${_baseURL}/basics/warehouses/${warehouseId}/locations/exports`, 'POST', {

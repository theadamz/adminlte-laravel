...
function initDataTable() {
    _dataTable = $('#list_datatable').DataTable({
        ...
        "ajax": {
            "url": `${_baseURL}/dt/basics/warehouses`,
            "type": "GET",
            "data": function (d) {
        ...
        "columns": [{
            ...
            {
                "data": "warehouse_locations_count",
                "orderable": false,
                "searchable": false,
                "className": "dt-center",
            },
...
async function saveData() {
    ...
    // prepare url
    url = `${_baseURL}/basics/warehouses`;
...
async function editData(id = null) {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/basics/warehouses/${_id}`, 'GET');
...
async function deleteData() {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/basics/warehouses`, "DELETE", _data2Send);
...
async function importData() {
    ...
    // send request
    const response = await axiosCustom(`${_baseURL}/basics/warehouses/imports`, "POST", _data2Send, null);
...
async function exportData() {
    ...
    // get data
    const response = await axiosCustom(`${_baseURL}/basics/warehouses/exports`, 'POST', {

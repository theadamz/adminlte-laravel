                ...
                <div class="modal-body">
                    ...
                    <form id="formInput" name="formInput" class="form">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group fv-row">
                                    ...
                                    <input type="email" id="email" name="email"
                                           class="form-control font-weight-normal" placeholder="Email" value=""
                            ...
                            <div class="col-md-12">
                                <div class="form-group fv-row">
                                    ...
                                    <input type="password" id="password" name="password"
                                           class="form-control font-weight-normal" placeholder="Password" maxlength="150"
                                           autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group fv-row">
                                    <label class="form-label font-weight-normal mb-1">Role <span
                                              class="text-danger">*</span></label>
                                    <select class="form-control font-weight-normal form-select2" id="role"
                                            name="role" data-dropdown-parent="#modalFormInput"
                            ...
                            <div class="col-md-12">
                                <div class="form-group fv-row">
                                    ...
                                    <select class="form-control font-weight-normal form-select2" id="timezone"
                                            name="timezone" data-dropdown-parent="#modalFormInput"
                                            data-allow-clear="false">
                                        <option value=""></option>

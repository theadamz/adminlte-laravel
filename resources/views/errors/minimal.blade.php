        ...
        <section class="content">
            <div class="error-page">
                ...
                <div class="error-content">
                    ...
                    <a href="{{ url()->previous() }}" class="btn btn-outline-secondary mr-3"><i
                            class="fas fa-arrow-left mr-2"></i> Back</a>
                    <a href="{{ url('/') }}" class="btn btn-outline-secondary mr-3"><i
                            class="fas fa-home mr-2"></i> Home</a>
                    <a href="{{ route('sign-out') }}" class="btn btn-outline-secondary mr-3"><i

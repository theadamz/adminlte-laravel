...
Route::prefix("categories")->middleware(['access:category'])->group(function () {
    ...
    Route::post('/imports', [\App\Http\Controllers\Basic\CategoryController::class, 'import'])->can('category-import');
...
Route::prefix("category-subs")->middleware(['access:category-sub'])->group(function () {
    ...
    Route::post('/imports', [\App\Http\Controllers\Basic\CategorySubController::class, 'import'])->can('category-sub-import');
...
Route::prefix("brands")->middleware(['access:brand'])->group(function () {
    ...
    Route::post('/imports', [\App\Http\Controllers\Basic\BrandController::class, 'import'])->can('brand-import');
...
Route::prefix("uoms")->middleware(['access:uom'])->group(function () {
    ...
    Route::post('/imports', [\App\Http\Controllers\Basic\UomController::class, 'import'])->can('uom-import');
...
Route::prefix("warehouses")->middleware(['access:warehouse'])->group(function () {
    ...
    Route::post('/imports', [\App\Http\Controllers\Basic\WarehouseController::class, 'import'])->can('warehouse-import');
    ...
    Route::post('/{warehouseId}/locations/imports', [\App\Http\Controllers\Basic\WarehouseLocationController::class, 'import'])->can('warehouse-location-import');
